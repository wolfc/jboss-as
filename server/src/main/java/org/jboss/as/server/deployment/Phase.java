...
public enum Phase {
    ...
    public static final int PARSE_EJB_DEPLOYMENT                        = 0x0850;
    // create and attach the ComponentConfiguration for EJBs
    public static final int PARSE_EJB_COMPONENT_CONFIG                  = 0x0860;
    ...
    public static final int DEPENDENCIES_EJB                            = 0xD00;
